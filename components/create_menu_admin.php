...
// //function register_certificates_menu() {
//     add_menu_page(
//         'Quản lý chứng chỉ đã cấp', // Page title
//         'Quản lý chứng chỉ đã cấp', // Menu title
//         'manage_options', // Capability
//         'certificates_admin', // Menu slug
//         'display_certificates_page', // Callback function
//         'dashicons-awards', // Icon
//         6 // Position
//     );
//}
//add_action('admin_menu', 'register_certificates_menu');
