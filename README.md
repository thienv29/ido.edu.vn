...
Bước 1: Vào trang quản lý chứng chỉ -> chọn tạo chứng chỉ -> nhập tên -> chọn kiểu là Dán nội dung hoặc tải file (yêu cầu phải có biến {name} và biến {date} trong nội dung của chứng chỉ). 3 Chứng chỉ Tình nguyện viên Id: 1, Nhà tài trợ Id: 2 và Thành viên Id: 3.
